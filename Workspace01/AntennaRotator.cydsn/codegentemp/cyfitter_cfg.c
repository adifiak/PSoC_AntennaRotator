...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000B6Cu)

/* UDB_0_5_0_CONFIG Address: CYDEV_UCFG_B0_P7_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_5_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000B74u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000C0Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000C18u)
